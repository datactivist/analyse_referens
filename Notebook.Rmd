...
On constate que ce sont beaucoup de métiers AI, beaucoup en soutien à la recherche. Hypothèse : on a vu que les corps IE et IR possèdent proportionnellement plus de métiers liés **aux** données, mais dans quels corps trouve-t-on les métiers **des** données (c'est-à-dire où le terme apparaît le plus fréquemment) ?

## Distribution des fiches métiers par corps

On trace la distribution des fiches métiers par corps, avec une représentation par boxplot :
...
Il apparaît que les corps IE et IR ont la distribution la plus étirée par le haut, ce sont ceux où l'on trouve le plus les métiers **des** données.

# TO DO

## Regarder les métiers des BAP E, F, G, J où "données" apparaît comme facteur d'évolution moyen terme
